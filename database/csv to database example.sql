...
LOAD DATA INFILE 'farmers.csv' INTO TABLE listings
...
LOAD DATA INFILE 'amenities.csv' INTO TABLE listingAmenities
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n' (listingId, amenity, amenityValue);

LOAD DATA INFILE 'states.csv' INTO TABLE states
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n' (abbrev, name);

LOAD DATA INFILE 'images.csv' INTO TABLE images
FIELDS TERMINATED BY ','
